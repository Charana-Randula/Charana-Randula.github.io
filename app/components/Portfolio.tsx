  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-black via-gray-900 to-black text-white">
      ...
      >
        ...
        <h1 className={`text-6xl font-bold mb-4 ${styles.gradientText}`}>Your Name</h1>
      ...
      <div id="content" className="container mx-auto px-4 py-16">
        <div className="flex gap-8 mb-16 justify-center">
          {['about', 'experience', 'projects', 'Certificates'].map((section) => (
            <button
              key={section}
        ...
        >
          ...
          {activeSection === 'contact' && (
            <div className={styles.card}>
              <h3 className={`text-4xl font-bold mb-6 ${styles.gradientText}`}>Contact</h3>
              <p className="text-gray-300 text-lg mb-4">Get in touch with me</p>
